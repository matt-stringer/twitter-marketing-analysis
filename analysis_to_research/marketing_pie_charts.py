	...
	for marketing_type in marketing:
		...
		for year, group in year_group:
			...
			if year < 2014:
    			...
    			if index <= num_plots:
    				plt.text(-0.05, -1.4, "Social Marketing Tweets: "+ str(total_yearly_tweets), ha='center', fontsize=13, fontweight='bold')

    			elif index > num_plots:
    				plt.text(-0.05, -1.4, "Direct Marketing Tweets: "+ str(total_yearly_tweets), ha='center', fontsize=13, fontweight='bold')
			...
			for year, group2 in installer_year_group:
				...
				if year < 2014: 
					...
					if yearly_tweets > 0:
						...
						name_group = group2.groupby(['classification']).count()
		    			...
		    			if installer_index <= num_plots:
		    				plt.text(-0.05, -1.4, "Social Marketing Tweets: "+ str(yearly_tweets), ha='center', fontsize=13, fontweight='bold')

		    			elif installer_index > num_plots:
		    				plt.text(-0.05, -1.4, "Direct Marketing Tweets: "+ str(yearly_tweets), ha='center', fontsize=13, fontweight='bold')
